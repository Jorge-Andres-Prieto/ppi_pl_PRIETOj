...
<ul>
  <li><a href="https://nachobot.streamlit.app/"><img src="ruta_del_icono_de_nacho_bot.png" alt="Nacho Bot" style="vertical-align: middle;"> Nacho Bot🤖</a>: Un chat bot que funciona con la API de OpenAI para resolver preguntas asociadas a la Universidad Nacional sede Medellín. <a href="https://github.com/Jorge-Andres-Prieto/Nacho_Bot">Repositorio</a></li>
  <li><a href="https://chatbot-un-e3y6wrkckde9tqvuknapp3u.streamlit.app/"><img src="ruta_del_icono_de_unal_bot.png" alt="UNalBot" style="vertical-align: middle;"> UNalBot</a>: UNalBot es un chatbot diseñado y creado por mí, un estudiante de la Universidad Nacional de Colombia, el bot está hecho para servir como un asistente virtual dentro de la misma universidad. <a href="https://github.com/Jorge-Andres-Prieto/Chat_Bot">Repositorio</a></li>
